  ...
  return (
    <div class="h-full bg-gradient-to-tl from-green-400 to-indigo-900 w-full py-16 px-4">
                ...
                <div class="flex flex-col items-center justify-center">
                    <header id='signintitle'><img src="https://scontent-bom1-1.xx.fbcdn.net/v/t39.30808-6/245923230_265650705484264_1264958416371648750_n.png?_nc_cat=102&ccb=1-5&_nc_sid=09cbfe&_nc_ohc=d5pSRz77uhQAX91PuyL&tn=tUoQJQaOP7ET-TEI&_nc_ht=scontent-bom1-1.xx&oh=00_AT-Enq-elKtjmvXW5dxtfaFxTtk49cUj7NwIabn1ZUgnWQ&oe=6276332C" alt="" /><p>Chi SquareX Technologies</p></header>
